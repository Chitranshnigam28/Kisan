...
//       <MdOutlineCancel
//         className="add-icon"
//         onClick={() => setShowAddFarm(false)} // Set to false to return to MyFarms view
//         style={{
//           fontSize: "1.5em",
//           cursor: "pointer",
//           marginLeft: "10px",
...
//         }}
//       />
//       {/* AddFarms component or content goes here */}
//       <AddFarms />
//     </>
//   ) : (
//     <>
//       <IoIosAddCircleOutline
//         className="add-icon"
//         onClick={() => setShowAddFarm(true)} // Set to true to show AddFarms view
//         style={{
//           fontSize: "1.5em",
//           cursor: "pointer",
//           marginLeft: "10px",
