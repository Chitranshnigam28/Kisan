                ...
                {["Low", "Moderate", "High"].map((quality) => (
                  <button
                    ...
                    className={`custom-button ${
                      farmData.soilQuality === quality ? "selected" : ""
                    }`}
              ...
              <div className="button-group">
                {[
                  ...
                  <button
                    ...
                    type="button"
                    className={`custom-button ${
                      farmData.cropName === name ? "selected" : ""
                    }`}
              ...
              <div className="button-group">
                {["Clay", "Sandy", "Loamy", "Silt"].map((soil) => (
                  <button
                    ...
                    type="button"
                    className={`custom-button ${
                      farmData.soilType === soil ? "selected" : ""
                    }`}
              ...
              <div className="button-group">
                {[
                  ...
                  <button
                    ...
                    type="button"
                    className={`custom-button ${
                      farmData.farmingMethod === method ? "selected" : ""
                    }`}
                    onClick={() => handleSelection("farmingMethod", method)}
                  >
                    <img
                      src={farmingMethodIcons[method]}
                      alt={`${method} icon`}
              ...
              <div className="button-group">
                {[
                  ...
                  <button
                    ...
                    type="button"
                    className={`custom-button ${
                      farmData.waterSource === source ? "selected" : ""
                    }`}
