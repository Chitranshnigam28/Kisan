...
const TranslationComponent = () => {
  ...
  // Function to recursively extract all text nodes from DOM
  ...
  // Function to save original content (English) in case we need to revert back
  ...
  // Function to restore the original English content
