...
//     const storedCity = localStorage.getItem("searchCity") || "Delhi"; // Default to "Delhi"
//     return { q: storedCity };
//   });
...
//       const currentCondition = weather?.weather?.[0]?.main || "Unknown"; // Access the main condition
//       // const currentCondition = data.weather[0].main; // Access the main condition
//       console.log("Current Weather Condition:", currentCondition); // Log the current condition
